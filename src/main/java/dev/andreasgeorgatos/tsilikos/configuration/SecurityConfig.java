package dev.andreasgeorgatos.tsilikos.configuration;

import dev.andreasgeorgatos.tsilikos.configuration.filters.TokenExtractionFilter;
...
//                    works
                    auth.requestMatchers(HttpMethod.GET, "/api/v1/users").hasAnyAuthority("Admin");
...
//works
                    ...
                    auth.requestMatchers(HttpMethod.POST, "/api/v1/addresses").hasAnyAuthority("Manager", "Admin");
